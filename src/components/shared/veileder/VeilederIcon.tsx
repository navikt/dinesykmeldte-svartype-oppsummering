...
function VeilederIcon(): JSX.Element {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 93" aria-labelledby="svgtitle1">
            <title id="svgtitle1">Veileding om personalansvar</title>
